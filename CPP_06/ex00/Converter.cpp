...
Converter::Converter(const std::string &input)
	: _int(0), _float(0), _double(0), _char(0), _str(input)
{
	convert();
}

Converter::Converter(const Converter &other)
	: _int(other._int), _float(other._float), _double(other._double), _char(other._char), _str(other._str), _isNan(other._isNan)
{}
...
void Converter::convert()
{
	...
	else if (_str == "-inf" || _str == "+inf" || _str == "nan" || _str == "-inff" || _str == "+inff" || _str == "nanf")
		_isNan = true;
	else
